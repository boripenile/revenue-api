...
VALUES (1, 'CJK2233001', 'Electronic Internally Generated Revenue System', 'Managing of State and Local Government Revenues in Nigeria', '1.0.0', 1, NOW(), 'system');
...
INSERT INTO `roles` (`id`, `application_id`,`role_name`, `description`, `created_at`, `created_by`) 
VALUES (2, 1, 'admin', 'State Board Administrator', NOW(), 'system');
...
INSERT INTO `roles` (`id`, `application_id`,`role_name`, `description`, `created_at`, `created_by`) 
VALUES (5, 1, 'customer', 'Tax Payer', NOW(), 'system');

INSERT INTO `roles` (`id`, `application_id`,`role_name`, `description`, `created_at`, `created_by`) 
VALUES (6, 1, 'executive', 'Executive Member', NOW(), 'system');
